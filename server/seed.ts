...
async function seed() {
  ...
  await db.insert(products).values([
    ...
    { productId: 'nilo', name: 'Nilo', tagline: 'Workspace for docs and databases', description: 'Pages, blocks and typed databases with comments, sharing and real-time collaboration. Your team’s workspace, on web, iOS and Android.', href: 'https://nilo.so', external: true, cta: 'Open Nilo', brand: '#0891b2', mark: 'N', category: categoryRef('apps'), section: 'apps', lifecycle: 'in-development', showOnProducts: true, showOnStatus: false, showInNav: true, order: 3 },
