...
async function seed() {
  ...
  await db.insert(products).values([
    ...
    { productId: 'allo', name: 'Allo', tagline: 'Private communication', description: 'Messaging and calling across the Oxy ecosystem.', href: 'https://allo.you', healthUrl: 'https://api.allo.you/', external: true, cta: 'Open Allo', brand: '#2563eb', mark: 'A', category: categoryRef('social-communication'), section: 'social-communication', lifecycle: 'live', showOnProducts: true, showOnStatus: true, showInNav: true, order: 2 },
    ...
    { productId: 'noted', name: 'Noted', tagline: 'Notes that stay yours', description: 'A private notes workspace with real-time collaboration.', href: 'https://noted.oxy.so', healthUrl: 'https://api.noted.oxy.so/health', external: true, cta: 'Open Noted', brand: '#7c3aed', mark: 'N', category: categoryRef('apps'), section: 'apps', lifecycle: 'live', showOnProducts: true, showOnStatus: true, showInNav: true, order: 4 },
    ...
    { productId: 'codea', name: 'Codea', tagline: 'Open-source code editor', description: 'A professional AI code editor that runs in your browser, on your machine, or self-hosted. Write, review and ship — on your terms.', href: '/codea', landingUrl: '/codea', healthUrl: 'https://oxy.so/codea', external: false, cta: 'Explore Codea', brand: '#0f172a', mark: 'C', category: categoryRef('developer'), section: 'developer', lifecycle: 'live', showOnProducts: true, showOnStatus: true, showInNav: true, order: 2 },
    ...
    { productId: 'oxy-ai', name: 'Oxy AI', tagline: 'Models, API and SDKs', description: 'Privacy-first AI for developers. Open models you can inspect, fine-tune and self-host — backed by a fast, multilingual API.', href: '/ai', healthUrl: 'https://oxy.so/ai', external: false, cta: 'Explore Oxy AI', brand: '#dc2626', mark: 'O', category: categoryRef('developer'), section: 'developer', lifecycle: 'live', showOnProducts: true, showOnStatus: true, showInNav: false, order: 0 },
    ...
    { productId: 'crowdsource', name: 'CrowdSource', tagline: 'Participatory moderation', description: 'Reports become cases, cases are judged by an independent jury drawn at random, and the versioned decision goes back to the app. Nobody can pick the case they review.', href: '/company/charter#6-governance-designed-for-fallible-people', external: false, cta: 'How it works', brand: '#6366f1', mark: 'C', category: categoryRef('infrastructure'), section: 'infrastructure', lifecycle: 'in-development', showOnProducts: true, showOnStatus: true, showInNav: false, order: 4 },
  ])
