...
const cases = [
  ...
  // ------------------------------------------------------------ manifests ---
  {
    ...
    files: filler({
      "packages/backend/package.json": `${JSON.stringify(
        { name: "oxy-website-api", dependencies: { mongoose: "^8.24.0" } },
        null,
        2,
      )}\n`,
    }),
  ...
  },
  {
    ...
    files: filler({
      "packages/backend/package.json": `${JSON.stringify(
        { name: "oxy-website-api", devDependencies: { "mongodb-memory-server": "^10.0.0" } },
        null,
        2,
      )}\n`,
    }),
  ...
  {
    // The regression this check exists for. `oxy-website-api` described itself
    ...
    files: filler({
      "packages/backend/package.json": `${JSON.stringify(
        { name: "oxy-website-api", description: "Express 5 / Mongoose / Socket.io backend for Mercaria" },
        null,
        2,
      )}\n`,
    }),
  ...
  },
  {
    ...
    files: filler({
      "packages/backend/package.json": `${JSON.stringify(
        { name: "oxy-website-api", keywords: ["api", "MongoDB"] },
        null,
        2,
      )}\n`,
    }),
  ...
  },
  {
    ...
    files: filler({
      "packages/backend/package.json": `${JSON.stringify(
        { name: "oxy-website-api", description: "Ranked among the fastest, deployed in Mongolia" },
        null,
        2,
      )}\n`,
    }),
