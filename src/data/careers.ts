...
export const jobDepartments: JobDepartment[] = [
  {
    ...
    jobs: [
      { title: 'Engineering Lead', location: 'London [Hybrid]', href: '/company/careers/engineering-lead-london-hybrid' },
      { title: 'Engineering Lead', location: 'Poland, Portugal, Ireland, Germany [Remote]', href: '/company/careers/engineering-lead-europe-remote' },
      { title: 'Platform Engineer', location: 'London, United Kingdom [Hybrid]', href: '/company/careers/platform-engineer-london-hybrid' },
      { title: 'Platform Engineer', location: 'Poland, Portugal, Ireland, Germany [Remote]', href: '/company/careers/platform-engineer-europe-remote' },
      { title: 'Product Engineer', location: 'London, United Kingdom [Hybrid]', href: '/company/careers/product-engineer-london-hybrid' },
      { title: 'Product Engineer', location: 'Poland, Portugal, Ireland, Germany [Remote]', href: '/company/careers/product-engineer-europe-remote' },
      { title: 'Security Operations Analyst', location: 'United Kingdom [Hybrid]', href: '/company/careers/security-operations-analyst-uk-hybrid' },
      { title: 'IT Engineer (Fixed-Term Contract)', location: 'London [Remote]', href: '/company/careers/it-engineer-london-remote' },
    ],
  },
  {
    name: 'GTM', id: 'gtm',
    jobs: [
      { title: 'Account Executive', location: 'London [Hybrid]', href: '/company/careers/account-executive-london-hybrid' },
      { title: 'Account Executive', location: 'United States [Hybrid]', href: '/company/careers/account-executive-us-hybrid' },
      { title: 'Customer Success Manager', location: 'London [Hybrid]', href: '/company/careers/customer-success-manager-london-hybrid' },
      { title: 'Customer Success Manager', location: 'New York [Hybrid]', href: '/company/careers/customer-success-manager-ny-hybrid' },
      { title: 'Customer Success Manager', location: 'San Francisco [Hybrid]', href: '/company/careers/customer-success-manager-sf-hybrid' },
      { title: 'Sales Manager', location: 'London [Hybrid]', href: '/company/careers/sales-manager-london-hybrid' },
      { title: 'Sales Manager', location: 'United States [Hybrid]', href: '/company/careers/sales-manager-us-hybrid' },
      { title: 'SDR Manager', location: 'New York [Hybrid]', href: '/company/careers/sdr-manager-ny-hybrid' },
      { title: 'SDR Manager', location: 'San Francisco [Hybrid]', href: '/company/careers/sdr-manager-sf-hybrid' },
    ],
  },
  {
    name: 'Marketing', id: 'marketing',
    jobs: [
      { title: 'Product Marketing Lead', location: 'London [Hybrid]', href: '/company/careers/product-marketing-lead-london-hybrid' },
    ],
  },
  {
    name: 'Operations', id: 'operations',
    jobs: [
      { title: 'Revenue Operations Lead', location: 'London [Hybrid]', href: '/company/careers/revenue-operations-lead-london-hybrid' },
    ],
  },
  {
    name: 'Product', id: 'product',
    jobs: [
      { title: 'Product Partnerships', location: 'San Francisco [Hybrid]', href: '/company/careers/product-partnerships-sf-hybrid' },
      { title: 'Product Manager', location: 'Europe and United Kingdom [Remote]', href: '/company/careers/product-manager-europe-remote' },
    ],
  },
  {
    name: 'Open Applications', id: 'open-applications',
    jobs: [
      { title: 'Open Application', location: 'London [Hybrid]', href: '/company/careers/open-application-london-hybrid' },
    ],
  },
]
