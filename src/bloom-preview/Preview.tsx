/**
 * The preview iframe's component, in its own module so the entry point stays an
 * entry point: a file that only mounts a tree has no exports, and fast refresh
 * needs the component to live somewhere it can replace.
 */
