      ...
      <div className="border-border border-x">
        ...
        <div className="relative grid grid-cols-12">
          <div ref={ref} className="relative col-[2/-2]">
            ...
            <svg width="1" height="100%" className="text-border mask-t-to-70% mask-t-from-0% absolute inset-y-0 left-0">
              <line x1="0.5" y1="0" x2="0.5" y2="100%" stroke="currentColor" strokeDasharray="4 6" strokeLinecap="round" />
            </svg>
            <svg width="1" height="100%" className="text-border mask-t-to-70% mask-t-from-0% absolute inset-y-0 right-0">
              <line x1="0.5" y1="0" x2="0.5" y2="100%" stroke="currentColor" strokeDasharray="4 6" strokeLinecap="round" />
            </svg>
          </div>
        </div>
        ...
        <div className="mask-b-from-50% mask-b-to-85% relative grid grid-flow-dense grid-cols-12 bg-linear-to-b from-background to-surface pt-1">
          <svg width="100%" height="100%" className="text-muted mask-x-from-90% absolute inset-0">
            <defs>
