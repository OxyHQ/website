...
export default function AccountPanel() {
  ...
  return (
    <div
      className="fixed top-0 right-0 z-40 h-full w-[400px] max-w-full border-l border-border bg-background shadow-xl transition-transform duration-300 ease-out"
