              ...
              <div className="flex items-center gap-1">
                {social.map(({ label, icon: Icon, href }) => (
                  <a
                    ...
                    className="group flex size-8 shrink-0 items-center justify-center rounded-full text-muted-foreground transition-colors duration-400 ease-in-out hover:bg-primary-subtle hover:text-primary-text hover:duration-150 active:text-primary-text active:duration-50"
