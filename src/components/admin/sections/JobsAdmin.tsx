      ...
      <div className="mt-6 flex flex-col gap-2">
        {jobs.map((j) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              {j.slug && (
                <a href={`/company/careers/${j.slug}`} target="_blank" rel="noopener noreferrer" className="rounded-full px-2 py-1 text-xs text-muted-foreground hover:text-foreground">View</a>
              )}
              {isDefault ? (
                <>
