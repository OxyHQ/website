...
function ArrowRight() {
  return (
    <svg
      ...
      viewBox="0 0 14 14"
      fill="none"
      className="relative shrink-0 text-secondary-foreground opacity-0 -translate-x-0.25 transition-[opacity,translate] duration-400 ease-in-out group-hover:translate-0 group-hover:opacity-100 group-hover:duration-150 group-active:translate-0 group-active:opacity-100 group-active:duration-50"
    >
      <path
        stroke="currentColor"
        strokeLinecap="round"
...
function AcademyIcon({ className = '' }: { className?: string }) {
  return (
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" className={className}>
      <rect width="44" height="44" rx="10" fill="#F0F2F5" />
      <path
  ...
  return (
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" className={className}>
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M18 19h8M18 22h8M18 25h5" stroke="#717A88" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  )
}
  ...
  if (icon === 'academy') {
    return (
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" className="size-7.5">
        <rect width="30" height="30" rx="7" fill="#F0F2F5" />
        <path d="M15 9l-7 3.5 7 3.5 7-3.5L15 9z" stroke="#717A88" strokeWidth="1.2" strokeLinejoin="round" />
        <path d="M10 14v4l5 2.5 5-2.5v-4" stroke="#717A88" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
  if (icon === 'reference') {
    return (
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" className="size-7.5">
        <rect width="30" height="30" rx="7" fill="#F0F2F5" />
        <path d="M10 9h10a1.5 1.5 0 011.5 1.5v9a1.5 1.5 0 01-1.5 1.5H10a1.5 1.5 0 01-1.5-1.5v-9A1.5 1.5 0 0110 9z" stroke="#717A88" strokeWidth="1.2" />
        <path d="M12 13h6M12 15.5h6M12 18h4" stroke="#717A88" strokeWidth="1.2" strokeLinecap="round" />
      </svg>
    )
  }
  return null
...
function HelpSidebar() {
  return (
    <nav className="col-[1/6] border-subtle-stroke border-r max-xl:col-[1/7] max-lg:hidden">
          ...
          <button className="relative inline-flex cursor-pointer items-center text-nowrap border transition-colors duration-300 ease-in-out hover:duration-50 active:duration-50 disabled:pointer-events-none disabled:cursor-default h-9 gap-x-1.5 rounded-[10px] px-3 text-sm button-outline justify-between pr-2 w-full">
            ...
            <div className="flex w-full items-center justify-between gap-2">
              ...
              <div className="flex gap-1">
                <div className="pointer-events-none text-accent-foreground text-xs leading-3 flex min-h-[22px] min-w-[22px] items-center justify-center rounded-md border-subtle-stroke border-x border-t border-b-2 bg-primary-background px-1 pt-[3px] pb-0.5 shadow-[0px_1px_0px_1px_#E4E7EC]">
                  &#8984;
                </div>
                <div className="pointer-events-none text-accent-foreground text-xs leading-3 flex min-h-[22px] min-w-[22px] items-center justify-center rounded-md border-subtle-stroke border-x border-t border-b-2 bg-primary-background px-1 pt-[3px] pb-0.5 shadow-[0px_1px_0px_1px_#E4E7EC]">
                  K
          ...
          <div className="mb-5 flex flex-col gap-5 lg:mb-8 lg:gap-8">
            {sidebarSections.map((section) => (
              <div key={section.name}>
                <a
                  className="flex items-center gap-[7px] rounded-[10px] py-px pl-px hover:bg-surface-subtle/80"
                ...
                <div className="mt-1 flex flex-col lg:gap-0.5">
                  {section.items.map((item) => (
                    <div key={item.label} className="group relative w-full">
                      ...
                      <a
                        className="inline-block w-full rounded-[10px] p-1.5 pr-2.5 pl-[38px] text-left text-[#717A88] text-sm hover:bg-[#F5F6F8]"
                        href={item.href}
                      >
                        {item.label}
                      </a>
        ...
        <div className="col-[2/-3] flex flex-col items-center pt-19 pb-10 max-lg:col-[1/-1] max-lg:pt-10">
          ...
          <div className="mt-10 flex w-full max-w-[558px] flex-col items-center md:mt-8">
            <button className="relative inline-flex cursor-pointer items-center justify-center text-nowrap border transition-colors duration-300 ease-in-out hover:duration-50 active:duration-50 disabled:pointer-events-none disabled:cursor-default h-11.5 gap-x-2 rounded-xl px-3.5 button-outline w-full pr-2.5 text-sm shadow-[0px_1px_2px_-1px_rgba(28,40,64,0.08),_0px_2px_4px_0px_rgba(28,40,64,0.04)]">
              ...
              <div className="flex gap-x-1 text-caption-foreground">
                <div className="flex size-7 items-center justify-center rounded-lg border border-subtle-stroke border-b-2 shadow-[0px_1px_0px_1px_#E4E7EC]">
                  &#8984;
                </div>
                <div className="flex size-7 items-center justify-center rounded-lg border border-subtle-stroke border-b-2 shadow-[0px_1px_0px_1px_#E4E7EC]">
                  K
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-2.5 gap-y-2 text-accent-foreground mt-4 md:mt-5">
              ...
              <ul className="flex gap-1.5 text-xs">
                {popularSearches.map((s) => (
                  <li key={s}>
                    <button className="relative inline-flex cursor-pointer items-center justify-center text-nowrap border transition-colors duration-300 ease-in-out hover:duration-50 active:duration-50 disabled:pointer-events-none disabled:cursor-default gap-x-1.5 rounded-[10px] px-2.5 text-xs button-outline !bg-secondary-background hover:!bg-surface-subtle !text-accent-foreground h-7">
                      {s}
                    </button>
                  </li>
                ))}
            ...
            {helpCategories.map((cat) => (
              ...
              >
                ...
                <div className="relative flex flex-col gap-1">
                  <h3 className="font-semibold text-secondary-foreground">{cat.name}</h3>
                  <p className="text-balance text-sm text-tertiary-foreground">{cat.description}</p>
                </div>
              </Link>
            ))}
          </div>
          ...
          <div className="flex flex-col justify-between gap-x-[clamp(24px,calc(33.8%-215.304px),105px)] gap-y-10 xl:flex-row self-stretch">
            <div className="w-full xl:max-w-96">
              ...
              <p className="mt-3 text-tertiary-foreground">
            ...
            <div>
              <ul>
                {gettingStartedArticles.map((article, i) => (
                  <li
                    key={article.title}
                    className="border-white-500 border-b pt-8 pb-[31px] first-of-type:pt-0"
                  >
              ...
              <a
                className="-m-px mt-7 inline-block rounded-sm p-px text-caption-foreground transition-[color] hover:text-black-800 active:text-accent-foreground"
                href="#"
              >
                See all articles...
              </a>
