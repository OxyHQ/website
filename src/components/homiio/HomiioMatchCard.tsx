...
export default function HomiioMatchCard() {
  return (
    <article className="w-[210px] rounded-3xl bg-card p-3 text-left shadow-[0_20px_50px_-20px_color-mix(in_srgb,var(--foreground)_40%,transparent)] ring-1 ring-foreground/5">
      <div className="relative">
        ...
        />
        <span className="absolute right-2 top-2 rounded-full bg-success px-2 py-0.5 text-xs font-bold text-success-foreground shadow">
          87%
        </span>
      </div>
