...
export default function HomeHeroSection() {
  return (
    <section className="flex w-full max-w-screen flex-col items-center justify-center overflow-x-clip bg-linear-to-b from-[#FAFAFB] to-[#FFFFFF] relative">
      <div className="container border-subtle-stroke lg:border-x">
        <div className="sticky top-[64px] grid h-[calc(100vh-64px)] w-full justify-center gap-9 lg:grid-rows-2 lg:gap-[52px] lg:px-6 lg:pt-[72px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-end">
            {/* Logo badge row */}
            <p className="text-sm font-medium text-tertiary-foreground tracking-wide uppercase">
              Trusted by leading teams
            </p>

            <h1 className="mt-6 max-w-[14ch] text-center text-heading-md md:text-heading-lg lg:text-heading-xl text-primary-foreground">
              {homeHero.title}
            </h1>

            <p className="mt-4 max-w-md text-pretty text-center text-lg text-tertiary-foreground md:text-xl">
              {homeHero.subtitle}
            </p>
          ...
          <div className="relative z-10 flex items-start justify-center px-4 lg:px-0">
            <div className="h-full w-full max-w-4xl rounded-2xl border border-subtle-stroke bg-white shadow-lg" />
          </div>
        </div>
      </div>
    </section>
