                  ...
                  {blogCategories.map((cat) => {
                    ...
                    return (
                      <li key={cat.label}>
                        ...
                        >
                          <span className={isActive ? 'shrink truncate text-primary-foreground' : 'text-accent-foreground'}>
                            {cat.label}
                          </span>
              ...
              <div className="relative isolate max-lg:col-[1/-1] col-[9/-1] max-xl:col-[7/-1]">
                {filteredArticles.map((article) => (
                  <div key={article.slug} className="relative z-10 bg-secondary-background" style={{ opacity: 1 }}>
                    ...
                    >
                      <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-80 group-hover:duration-50 group-active:opacity-100 group-active:duration-50 bg-surface-subtle" />
                      ...
                      <p className="relative col-[2/-2] line-clamp-2 max-w-[28em] text-pretty pt-2 text-accent-foreground text-sm max-xl:text-sm">
                        {article.excerpt}
                      </p>
                    </a>
