...
function StatCard({
  ...
  const statsContent = (
    <div className="bg-surface p-5 md:p-8 w-full min-h-[160px] h-full flex flex-col justify-end">
  ...
  const infoContentView = (
    <div className="bg-surface p-5 md:p-8 w-full h-full overflow-y-auto flex flex-col justify-end gap-y-2">
      {href ? (
        <a
          href={href}
