...
// same width / fill props as the Remix icons beside it in POINTS.
const GithubIcon: BloomIconComponent = ({ width = 20, fill = 'currentColor' }) => (
          ...
          {POINTS.map((point, idx) => (
            ...
            >
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-primary/10 text-primary">
                <point.icon width={20} height={20} fill="currentColor" />
              </span>
