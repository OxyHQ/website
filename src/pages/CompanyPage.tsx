    ...
    <div className="flex min-h-screen max-w-screen flex-col overflow-x-clip bg-background">
      ...
      <main>
        ...
        <section className="py-24 sm:py-32 lg:py-40">
          <div className="mx-auto w-full max-w-3xl px-4 text-center lg:px-6">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              <Button variant="primary" size="md" href="/initiative">
                Our initiative
              </Button>
              <Button variant="outline" size="md" href="/company/careers">
                View careers
              </Button>
            </div>
          </div>
        ...
        {/* ═══ Stats ═══ */}
        <section className="border-border border-y py-12 sm:py-16">
          ...
          <section className="py-16 sm:py-24">
            <div className="mx-auto w-full max-w-7xl px-4 lg:px-6">
              <div className="flex items-end justify-between">
                <h2 className="text-3xl font-medium tracking-tight text-foreground md:text-4xl">Latest news</h2>
        ...
        <section className="border-border border-t py-16 sm:py-24">
          <div className="mx-auto w-full max-w-3xl px-4 text-center lg:px-6">
            <h2 className="text-3xl font-medium tracking-tight text-foreground md:text-4xl">Join the team</h2>
            ...
            <div className="mt-8">
              <Button variant="primary" size="lg" href="/company/careers">
                View open positions
              </Button>
            </div>
          </div>
