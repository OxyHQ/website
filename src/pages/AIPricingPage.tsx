...
function StarIcon() {
  return (
    <svg width="38" height="38" viewBox="0 0 38 38" fill="none" className="size-6 text-brand-blue2 mb-4">
            ...
            <section className="mb-6 flex md:mt-12 md:mb-10 lg:mt-12 lg:mb-15">
              <div id="pricing-plans" className="flex flex-col gap-2 lg:flex-row w-full">
                ...
                <div className="flex flex-1 gap-2">
                  {/* Starter */}
                  <div className="relative flex flex-1 flex-col rounded-2xl p-4 xl:p-8 bg-brand-forest text-white">
                  ...
                  <div className="flex flex-1">
                    <div className="relative flex flex-1 flex-col rounded-2xl p-4 xl:p-8 bg-brand-rose text-white">
                      <div className="size-6 flex items-center mb-4">
              ...
              <div className="flex sticky top-14 gap-3 bg-background border-b border-border z-10">
                ...
                <div className="flex-1 pt-2 pb-3 flex flex-col items-start gap-1">
                  <div className="font-semibold flex items-center gap-2">
                    <span className="size-3 flex-none rounded-full bg-brand-green" />
                    <span className="flex-1">Starter <span className="text-muted-foreground font-normal hidden lg:inline">for everyone</span></span>
                  </div>
                  <a className="bg-brand-forest rounded-2xl px-3 py-1 text-sm md:text-base text-white hover:rounded-none transition-all duration-200 font-normal" href="/signup">Sign up</a>
                </div>
                {/* Pro header */}
                <div className="flex-1 pt-2 pb-3 flex flex-col items-start gap-1">
                  <div className="font-semibold flex items-center justify-center gap-2">
                    <span className="size-2.5 flex-none bg-brand-pink" />
                    <span>Pro <span className="text-muted-foreground font-normal hidden lg:inline">for growing teams</span></span>
                  </div>
                  <a className="bg-brand-rose rounded-2xl text-sm md:text-base px-3 py-1 font-normal group flex-none text-white hover:rounded-none transition-all duration-200" href="/signup">Get Pro</a>
                </div>
                {/* Enterprise header */}
                <div className="flex-1 pt-2 pb-3 flex flex-col items-start gap-1">
                  <div className="font-semibold flex items-center justify-center gap-2">
                  ...
                  <a className="bg-brand-blue text-nowrap hover:rounded-none text-white rounded-2xl block px-3 gap-2 py-1 flex-none text-sm md:text-base transition-all duration-200" href="/contact">Contact sales</a>
                </div>
              </div>
