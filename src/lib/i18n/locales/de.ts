...
const de: Translations = {
  ...
  home: {
    ...
    tagBloom: 'Bloom',
    tagAcademy: 'Academy',
    tagPayments: 'Zahlungen',
    tagEncryption: 'Verschlüsselung',
    tagAccessibility: 'Barrierefreiheit',
    tagDevelopers: 'Entwickler',
    tagHousing: 'Wohnen',
    tagTransparency: 'Transparenz',
    tagEducation: 'Bildung',
    tagWellbeing: 'Wohlbefinden',
    tagMessaging: 'Nachrichten',
    tagTranslation: 'Übersetzung',
  },
  pricing: {
    seoTitle: 'Preise',
    seoDescription:
  ...
  academy: {
    ...
    openMenu: 'Kurse',
    openMenuLabel: 'Kursliste öffnen',
    yourProgress: 'Dein Fortschritt',
    progressNone: 'Beginne einen Kurs, dann erscheint dein Fortschritt hier.',
    progressLessons: '{done} von {total} Lektionen abgeschlossen',
    progressCourses: '{started} von {total} Kursen begonnen',
    progressCompleted: '{count} abgeschlossen',
    ...
    trackDeveloperBlurb: 'APIs, SDKs und die Entwicklerplattform.',
    comingSoon: 'Demnächst',
    levelBeginner: 'Einsteiger',
    levelIntermediate: 'Fortgeschritten',
    levelAdvanced: 'Experte',
    lessonsOne: '1 Lektion',
    lessonsOther: '{count} Lektionen',
    continueLearning: 'Weiterlernen',
    nextUp: 'Als Nächstes: {lesson}',
    upNext: 'Als Nächstes',
    continue: 'Weiter',
    startHere: 'Hier beginnen',
    startCourse: 'Kurs starten',
    continueLesson: 'Weiter: {lesson}',
    ...
    curriculum: 'Lehrplan',
    shareCourse: 'Diesen Kurs teilen',
    lessonOf: 'Lektion {n} von {total}',
    onThisPage: 'Auf dieser Seite',
    headingProgress: 'Abschnitt {at} von {total}',
    markComplete: 'Als abgeschlossen markieren',
    lessonDone: 'Lektion abgeschlossen',
    lessonPrompt: 'Lektion fertig?',
    lessonPromptHint: 'Markiere sie als abgeschlossen, damit du weißt, wo du stehst.',
    savedOnDevice: 'Dein Fortschritt wird auf diesem Gerät gespeichert.',
    savedToAccount: 'Dein Fortschritt wird in deinem Oxy-Konto gespeichert.',
    previous: 'Zurück',
    next: 'Weiter',
    ...
    notFoundCourseBody: 'Diesen Kurs gibt es nicht, oder er wurde verschoben.',
  ...
  newsroom: {
    ...
    sharePost: 'Teilen',
    sortLabel: 'Artikel sortieren: {option}',
