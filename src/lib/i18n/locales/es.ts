...
const es: Translations = {
  ...
  home: {
    ...
    tagAcademy: 'Academy',
    tagPayments: 'Pagos',
    tagEncryption: 'Cifrado',
    tagAccessibility: 'Accesibilidad',
    tagDevelopers: 'Desarrolladores',
    tagHousing: 'Vivienda',
    tagTransparency: 'Transparencia',
    tagEducation: 'Educación',
    tagWellbeing: 'Bienestar',
    tagMessaging: 'Mensajería',
    tagTranslation: 'Traducción',
  },
  pricing: {
    seoTitle: 'Precios',
    seoDescription:
  ...
  academy: {
    ...
    openMenu: 'Cursos',
    openMenuLabel: 'Abrir la lista de cursos',
    yourProgress: 'Tu progreso',
    progressNone: 'Empieza un curso y tu progreso aparecerá aquí.',
    progressLessons: '{done} de {total} lecciones completadas',
    progressCourses: '{started} de {total} cursos empezados',
    progressCompleted: '{count} terminados',
    trackFoundations: 'Fundamentos',
    trackFoundationsBlurb: 'Configura tu cuenta y da tus primeros pasos en Oxy.',
    trackIdentity: 'Identidad y seguridad',
    trackIdentityBlurb: 'Controla tu Oxy ID: claves, sesiones y recuperación de la cuenta.',
    trackSocial: 'Social y publicación',
    trackSocialBlurb: 'Haz crecer tu audiencia con Mention y el fediverso.',
    trackDeveloper: 'Construye sobre Oxy',
    trackDeveloperBlurb: 'API, SDK y la plataforma para desarrolladores.',
    comingSoon: 'Próximamente',
    levelBeginner: 'Principiante',
    levelIntermediate: 'Intermedio',
    levelAdvanced: 'Avanzado',
    lessonsOne: '1 lección',
    lessonsOther: '{count} lecciones',
    continueLearning: 'Sigue aprendiendo',
    nextUp: 'A continuación: {lesson}',
    upNext: 'Siguiente',
    continue: 'Continuar',
    ...
    noResultsTitle: 'Nada coincide con «{query}»',
    noResultsBody: 'Prueba con otra palabra o borra la búsqueda para ver todos los cursos.',
    clearSearch: 'Borrar búsqueda',
    courseProgress: '{done} de {total} lecciones completadas',
    ...
    headingProgress: 'Apartado {at} de {total}',
    markComplete: 'Marcar como completada',
    lessonDone: 'Lección completada',
    lessonPrompt: '¿Has terminado esta lección?',
    lessonPromptHint: 'Márcala como completada para saber siempre por dónde vas.',
    savedOnDevice: 'Tu progreso se guarda en este dispositivo.',
    savedToAccount: 'Tu progreso se guarda en tu cuenta de Oxy.',
    previous: 'Anterior',
    next: 'Siguiente',
    ...
    notFoundCourseBody: 'Este curso no existe o se ha movido.',
