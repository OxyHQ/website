...
const en = {
  ...
  academy: {
    ...
    openMenu: 'Courses',
    openMenuLabel: 'Open the course list',
    yourProgress: 'Your progress',
    progressNone: 'Start a course and your progress will show up here.',
    progressLessons: '{done} of {total} lessons completed',
    progressCourses: '{started} of {total} courses started',
    progressCompleted: '{count} finished',
    trackFoundations: 'Foundations',
    trackFoundationsBlurb: 'Set up your account and take your first steps on Oxy.',
    trackIdentity: 'Identity & security',
    trackIdentityBlurb: 'Own your Oxy ID — keys, sessions and account recovery.',
    trackSocial: 'Social & publishing',
    trackSocialBlurb: 'Grow your audience with Mention and the fediverse.',
    trackDeveloper: 'Build on Oxy',
    trackDeveloperBlurb: 'APIs, SDKs and the developer platform.',
    comingSoon: 'Coming soon',
    levelBeginner: 'Beginner',
    levelIntermediate: 'Intermediate',
    levelAdvanced: 'Advanced',
    lessonsOne: '1 lesson',
    lessonsOther: '{count} lessons',
    ...
    noResultsBody: 'Try another word, or clear the search to browse every course.',
    clearSearch: 'Clear search',
    courseProgress: '{done} of {total} lessons completed',
    ...
    headingProgress: 'Heading {at} of {total}',
    markComplete: 'Mark as complete',
    lessonDone: 'Lesson completed',
    lessonPrompt: 'Finished this lesson?',
    lessonPromptHint: 'Mark it complete to keep track of where you are.',
    savedOnDevice: 'Your progress is saved on this device.',
    savedToAccount: 'Your progress is saved to your Oxy account.',
    previous: 'Previous',
    next: 'Next',
    ...
    notFoundCourseBody: 'This course does not exist, or it has moved.',
