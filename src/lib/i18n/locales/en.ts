...
const en = {
  ...
  home: {
    ...
    tickerRoleFairCoin: 'A community-run currency for cooperation',
    ...
    partnershipTitle: 'Build the future with us',
    partnershipDescription: 'Whether you’re a developer, designer, activist, or dreamer — there’s a place for you in the Oxy ecosystem.',
