  ...
  propTypes: {
    'InputOtpProps': {
      props: [
        ...
        { name: 'invalid', type: 'boolean', optional: true, description: 'Paint every box invalid.' },
        ...
        { name: 'accessibilityLabel', type: 'string', optional: true, description: "The group's accessible name." },
